...
module PigglyParser
  ...
  def _nt_stmtForEachLoop
                                      ...
                                      if r25
                                        ...
                                        if r26
                                          ...
                                          if r27
                                            ...
                                            if s29.last
                                              r29 = instantiate_node(Piggly::Parser::Nodes::TLabel,input, i29...index, s29)
                                              r29.extend(StmtForEachLoop1)
                                            else
                                              @index = i29
                                              r29 = nil
                                            end
    ...
    if r1
      ...
      if s36.last
        r36 = instantiate_node(Piggly::Parser::Nodes::ForEachLoop,input, i36...index, s36)
        r36.extend(StmtForEachLoop4)
      else
        @index = i36
        r36 = nil
      end
  ...
  def _nt_stmtAssert
    start_index = index
    if node_cache[:stmtAssert].has_key?(index)
      cached = node_cache[:stmtAssert][index]
      if cached
        node_cache[:stmtAssert][index] = cached = SyntaxNode.new(input, index...(index + 1)) if cached == true
        @index = cached.interval.end
      end
      return cached
    end
    ...
    if r2
      ...
      if r3
        ...
        s1 << r4
        if r4
          r5 = _nt_expressionUntilSemiColonOrComma
          s1 << r5
          if r5
            if (match_len = has_terminal?(',', false, index))
              r6 = true
    ...
    if s1.last
      r1 = instantiate_node(Piggly::Parser::Nodes::Assert,input, i1...index, s1)
      r1.extend(StmtAssert0)
    else
      @index = i1
      r1 = nil
    end
    if r1
      ...
      if r12
        ...
        if r13
          ...
          s11 << r14
          if r14
            r15 = _nt_expressionUntilSemiColon
            s11 << r15
            if r15
              if (match_len = has_terminal?(';', false, index))
                r16 = true
      ...
      if s11.last
        r11 = instantiate_node(Piggly::Parser::Nodes::Assert,input, i11...index, s11)
        r11.extend(StmtAssert1)
      else
        @index = i11
        r11 = nil
      end
    ...
    node_cache[:stmtAssert][start_index] = r0
        ...
        if r5
          ...
          if r6
            ...
            if r7
              ...
              if s8.last
                r8 = instantiate_node(SyntaxNode,input, i8...index, s8)
                r8.extend(ExpressionUntilSemiColon0)
              else
                @index = i8
                r8 = nil
              end
              if r8
                ...
                if s12.last
                  r12 = instantiate_node(SyntaxNode,input, i12...index, s12)
                  r12.extend(ExpressionUntilSemiColon1)
                else
                  @index = i12
                  r12 = nil
                end
  ...
  module ExpressionUntilSemiColonOrComma0
    def tSpace
      elements[0]
    end
  ...
  module ExpressionUntilSemiColonOrComma1
  end

  module ExpressionUntilSemiColonOrComma2
    def head
      elements[0]
    end
  ...
  def _nt_expressionUntilSemiColonOrComma
    start_index = index
    if node_cache[:expressionUntilSemiColonOrComma].has_key?(index)
      cached = node_cache[:expressionUntilSemiColonOrComma][index]
      if cached
        node_cache[:expressionUntilSemiColonOrComma][index] = cached = SyntaxNode.new(input, index...(index + 1)) if cached == true
        @index = cached.interval.end
      end
      return cached
    end
        ...
        if r5
          ...
          if r6
            ...
            if r7
              ...
              if s8.last
                r8 = instantiate_node(SyntaxNode,input, i8...index, s8)
                r8.extend(ExpressionUntilSemiColonOrComma0)
              else
                @index = i8
                r8 = nil
              end
              if r8
                ...
                if s12.last
                  r12 = instantiate_node(SyntaxNode,input, i12...index, s12)
                  r12.extend(ExpressionUntilSemiColonOrComma1)
                else
                  @index = i12
                  r12 = nil
                end
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::Expression,input, i0...index, s0)
      r0.extend(ExpressionUntilSemiColonOrComma2)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:expressionUntilSemiColonOrComma][start_index] = r0
  ...
  def _nt_expressionUntilThen
          ...
          if r6
            ...
            if r7
              ...
              if r11
                ...
                if s15.last
                  r15 = instantiate_node(SyntaxNode,input, i15...index, s15)
                  r15.extend(ExpressionUntilThen2)
                else
                  @index = i15
                  r15 = nil
                end
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::Expression,input, i0...index, s0)
      r0.extend(ExpressionUntilThen3)
    else
      @index = i0
      r0 = nil
    end
  ...
  def _nt_expressionUntilWhen
          ...
          if r6
            ...
            if r7
              ...
              if r11
                ...
                if s15.last
                  r15 = instantiate_node(SyntaxNode,input, i15...index, s15)
                  r15.extend(ExpressionUntilWhen2)
                else
                  @index = i15
                  r15 = nil
                end
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::Expression,input, i0...index, s0)
      r0.extend(ExpressionUntilWhen3)
    else
      @index = i0
      r0 = nil
    end
  ...
  def _nt_expressionUntilLoop
          ...
          if r6
            ...
            if r7
              ...
              if r11
                ...
                if s15.last
                  r15 = instantiate_node(SyntaxNode,input, i15...index, s15)
                  r15.extend(ExpressionUntilLoop2)
                else
                  @index = i15
                  r15 = nil
                end
    ...
    if s0.last
      r0 = instantiate_node(Piggly::Parser::Nodes::Expression,input, i0...index, s0)
      r0.extend(ExpressionUntilLoop3)
    else
      @index = i0
      r0 = nil
    end
  ...
  def _nt_parenExpr
    ...
    if s0.last
      r0 = instantiate_node(SyntaxNode,input, i0...index, s0)
      r0.extend(ParenExpr0)
    else
      @index = i0
      r0 = nil
    end

    node_cache[:parenExpr][start_index] = r0
  ...
  def _nt_dollarQuoteMarker
    ...
    if r1
      ...
      if r4
        s5, i5 = [], index
        loop do
          if has_terminal?(@regexps[gr = '\A[a-z\\u0080-\\uFFFF_0-9]'] ||= Regexp.new(gr), :regexp, index)
            r6 = true
            @index += 1
          else
            terminal_parse_failure('[a-z\\u0080-\\uFFFF_0-9]')
            r6 = nil
          end
          if r6
            s5 << r6
  ...
  def _nt_kwASSERT
    start_index = index
    if node_cache[:kwASSERT].has_key?(index)
      cached = node_cache[:kwASSERT][index]
      if cached
        node_cache[:kwASSERT][index] = cached = SyntaxNode.new(input, index...(index + 1)) if cached == true
        @index = cached.interval.end
      end
      return cached
    end
    ...
    node_cache[:kwASSERT][start_index] = r0
  ...
  def _nt_kwSLICE
    ...
    node_cache[:kwSLICE][start_index] = r0
